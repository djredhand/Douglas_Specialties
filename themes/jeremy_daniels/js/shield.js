...
function buildshieldbox() {
	...
	nobrowsercommentdiv.innerHTML = 'For a better experience using this site, please upgrade to a recommended recent web browser.';
